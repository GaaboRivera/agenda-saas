        ...
        <div className="grid grid-cols-2 gap-8 lg:grid-cols-6">
          ...
          <div className="col-span-2">
            ...
            <p className="mt-4 text-sm text-primary-foreground/70 max-w-xs leading-relaxed">
              La plataforma de agenda digital más completa para profesionales y
              equipos que valoran su tiempo.
            </p>
            <div className="mt-6">
              ...
              <form className="mt-2 flex gap-2">
                <input
                  ...
                  className="flex-1 rounded-lg bg-primary-foreground/10 px-4 py-2 text-sm text-primary-foreground placeholder:text-primary-foreground/50 focus:outline-none focus:ring-2 focus:ring-accent"
                />
                <button
                  type="submit"
