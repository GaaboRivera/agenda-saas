    ...
    <section id="contacto" className="py-24 bg-card">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          <span className="text-sm font-semibold text-accent">Contacto</span>
          <h2 className="mt-2 text-3xl font-bold tracking-tight text-foreground sm:text-4xl text-balance">
            ¿Tienes preguntas? Estamos aquí para ayudarte
          </h2>
          <p className="mt-4 text-lg text-muted-foreground">
            Nuestro equipo de soporte está disponible para resolver todas tus
            dudas.
          </p>
        </div>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">soporte@agendapro.com</p>
                  <p className="text-muted-foreground">ventas@agendapro.com</p>
                </div>
              </div>
